...
const NavBar = ({ onLogout, auth }) => {
  ...
  const userIconDropdown = () => {
    return (
      <>
        <i className="fab fa-nintendo-switch mr-0" /> {auth.user.username}
      </>
    );
  };
  ...
  return (
    <div className="fixed-top">
      ...
      <Navbar
        ...
        style={{
          backgroundColor: `${colorThemes[themeIdx].primary}`,
          transition: "all 0.3s",
        }}
      >
        <div className="container-fluid">
          <LinkContainer to="/" exact>
            <Navbar.Brand id="nav-brand">
              <span className="japanese">共天堂</span> kyotendo
            </Navbar.Brand>
          </LinkContainer>
                ...
                <>
                  <LinkContainer to="/auth">
                    <Nav.Link active={false}>
                      <i className="fab fa-nintendo-switch pr-2" />
                      login/signup
                    </Nav.Link>
                  </LinkContainer>
                </>
      ...
      <Navbar
        ...
        style={{
          transition: "all 0.3s",
          opacity: "0.9",
          backgroundColor: `${colorThemes[themeIdx].secondary}`,
        }}
      ></Navbar>

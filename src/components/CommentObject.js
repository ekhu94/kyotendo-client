...
const CommentObject = ({
  ...
  const onEditFormSubmit = (data, e) => {
    ...
    if (auth.user.id) {
      ...
      api.comment.editComment(comment.id, updatedComment).then(onCommentCreate);
    }
  };
        ...
        <List.Content>
          <Row>
            <div className="col-11 ml-4 mb-1">
              ...
              <span style={{ fontSize: "0.8rem" }} className="text-muted ml-2">
                {formatCreateDate(comment.created_at)}
              </span>
                    ...
                    <Fade in={editOpen}>
                      ...
                      >
                        ...
                        <Row className="justify-content-end">
                          <Button
                            className="mr-3 py-1 px-2 comment-btn"
                            variant="primary"
                            type="submit"
                          >
                            Update Comment
          ...
          {!editOpen ? (
            <Row className="align-items-center">
              <div className="col-10 ml-5" style={{ lineHeight: "1.6" }}>
                <List.Description>{comment.content}</List.Description>
              </div>
            </Row>
          ) : null}
        </List.Content>
